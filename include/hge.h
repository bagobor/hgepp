...
public:
    inline void                 System_SetState(system_state_bool_t   state, bool        value) { System_SetStateBool  (state, value); }
    inline void                 System_SetState(system_state_func_t   state, void_callback_t value) { System_SetStateFunc  (state, value); }
    inline void                 System_SetState(system_state_hwnd_t   state, HWND        value) { System_SetStateHwnd  (state, value); }
    inline void                 System_SetState(system_state_int_t    state, int         value) { System_SetStateInt   (state, value); }
    inline void                 System_SetState(system_state_string_t state, const char *value) { System_SetStateString(state, value); }
    inline bool                 System_GetState(system_state_bool_t   state) { return System_GetStateBool  (state); }
    inline void_callback_t      System_GetState(system_state_func_t   state) { return System_GetStateFunc  (state); }
    inline HWND                 System_GetState(system_state_hwnd_t   state) { return System_GetStateHwnd  (state); }
    inline int                  System_GetState(system_state_int_t    state) { return System_GetStateInt   (state); }
    inline const char*          System_GetState(system_state_string_t state) { return System_GetStateString(state); }
